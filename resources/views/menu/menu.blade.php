...
<script type="text/javascript">
    ...
    $('#addMenuForm').on('submit', function (e) {
        ...
        axios.post('/khut-bd-admin/public/menu/store', formData)
            .then(res => {
                if (res.data.success) {
    ...
    $('#editMenuForm').on('submit', function (e) {
            ...
            axios.post('/khut-bd-admin/public/menu/update/' + id, { name: name })
                .then(res => {
    ...
    $(document).ready(function () {
        ...
        $('#addSubmenuForm').on('submit', function (e) {
            ...
            axios.post('/khut-bd-admin/public/submenu/store', formData)
                .then(res => {
                    if (res.data.success) {
    ...
    $('#addChildmenuForm').on('submit', function (e) {
        ...
        axios.post('/khut-bd-admin/public/childmenu/store', formData)
            .then(res => {
                if (res.data.success) {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        document.querySelectorAll('.toggle-submenu').forEach(function (btn) {
            btn.addEventListener('click', function () {
                ...
                axios.get(`/khut-bd-admin/public/submenu/by-main/${menuId}`)
    ...
    $(document).on('click', '.showChildMenuBtn', function () {
        ...
        axios.get(`/khut-bd-admin/public/childmenu/by-submenu/${submenuId}`)
            .then(res => {
   ...
   // Show edit submenu modal with data
    $(document).on('click', '.editSubmenuBtn', function () {
        ...
        axios.get(`/khut-bd-admin/public/submenu/edit/${id}`)
            .then(res => {
    ...
    $('#editSubmenuForm').submit(function (e) {
        ...
        axios.post('/khut-bd-admin/public/submenu/update', formData)
            .then(res => {
                if (res.data.success) {
  ...
  $(document).on('click', '.editChildmenuBtn', function () {
    ...
    axios.get(`/khut-bd-admin/public/childmenu/edit/${id}`)
        .then(response => {
    ...
    $('#mainMenuSelect').on('change', function () {
        ...
        axios.get(`/khut-bd-admin/public/submenu/by-main/${mainId}`)
            .then(res => {
    ...
    $('#editChildmenuForm').submit(function (e) {
        ...
        $.ajax({
            url: '/khut-bd-admin/public/childmenu/update',
            method: 'POST',
            data: formData,
            processData: false,
            contentType: false,
    ...
    $(document).on("click", ".deleteMenuBtn", function () {
        ...
        if (result.isConfirmed) {
            $.ajax({
            url: `/khut-bd-admin/public/${type}menu/delete/${id}`,
            type: "DELETE",
            headers: {
                "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr("content"),
            },
