    ...
    <script>
       $.ajaxSetup({
        ...
        $('#addcommonSizeBtn').click(function () {
            ...
            $.post('/khut-bd-admin/public/common-size/store', {common_size: commonSizeName}, function(res) {
        ...
        $(document).on('click', '.updatecommonSizeBtn', function () {
            ...
            $.ajax({
                url: '/khut-bd-admin/public/common-size/update',
                type: 'POST',
        ...
        $(document).on('click', '.deletecommonSizeBtn', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '/khut-bd-admin/public/common-size/delete/' + id,
                        type: 'DELETE',
