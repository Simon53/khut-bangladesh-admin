      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
         ...
         <div class="form-group">
            ...
            <br>
            <img id="edit_image_preview" src="{{ $story->image ?? '' }}"  alt="Current Image" style="max-width: 100%; max-height: 150px; margin-top:10px;">
        </div>
        </div>
...
$('#editForm').on('submit', function(e) {
  ...
  $.ajax({
    url: '/khut-bd-admin/public/khut-stories/update/' + pageId,
    method: 'POST',
    data: formData,
    processData: false,
    contentType: false,
