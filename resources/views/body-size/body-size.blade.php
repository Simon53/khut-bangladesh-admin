    ...
    <script>
       $.ajaxSetup({
        ...
        $('#addBodySizeBtn').click(function () {
            ...
            $.post('/khut-bd-admin/public/body-size/store', {body_size: bodySizeName}, function(res) {
        ...
        $(document).on('click', '.updateBodySizeBtn', function () {
            ...
            $.ajax({
                url: '/khut-bd-admin/public/body-size/update',
                type: 'POST',
        ...
        $(document).on('click', '.deleteBodySizeBtn', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '/khut-bd-admin/public/body-size/delete/' + id,
                        type: 'DELETE',
