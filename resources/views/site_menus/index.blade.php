...
$('#addMenuForm').on('submit', function(e) {
    ...
    $.ajax({
        url: '/khut-bd-admin/public/admin/site-menus/store', // ✅ create route
        type: 'POST',
        data: formData,
        contentType: false,
        processData: false,
...
$(document).ready(function () {
    ...
    $('#editMenuForm').on('submit', function (e) {
        ...
        $.ajax({
            url: '/khut-bd-admin/public/admin/site-menus/update/' + id,
            type: 'POST',
            data: formData,
            contentType: false,
            processData: false,
...
$('.deleteMenuBtn').on('click', function () {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: '/khut-bd-admin/public/admin/site-menus/delete/' + id,
                type: 'DELETE',
                data: {
