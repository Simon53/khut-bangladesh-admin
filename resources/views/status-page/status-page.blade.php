    ...
    <script>
       $.ajaxSetup({
        ...
        $('#addstatusBtn').click(function () {
            ...
            $.post('/khut-bd-admin/public/status-page/store', {status: statusName}, function(res) {
       ...
       $(document).on('click', '.editstatusBtn', function () {
        ...
        $(document).on('click', '.updatestatusBtn', function () {
            ...
            $.ajax({
                url: '/khut-bd-admin/public/status-page/update',
                type: 'POST',
        ...
        $(document).on('click', '.deletestatusBtn', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '/khut-bd-admin/public/status-page/delete/' + id,
                        type: 'DELETE',
